...
>
  <div className="flex flex-col gap-2 pb-2">
    ...
    {/* GOOGLE TLAČÍTKO – Odpovídá Google Branding Guidelines */}
    <button
      onClick={signInWithGoogle}
      type="button"
      className="w-full h-10 px-3 bg-white border border-[#747775] text-[#1f1f1f] text-sm font-medium rounded-2xl cursor-pointer flex items-center justify-between relative overflow-hidden transition-all duration-200 hover:bg-[#303030]/[0.08] hover:shadow-[0_1px_2px_0_rgba(60,64,67,0.3),0_1px_3px_1px_rgba(60,64,67,0.15)] active:bg-[#303030]/[0.12] focus:outline-none"
      style={{ fontFamily: "'Roboto', arial, sans-serif" }}
    >
      <div className="w-5 h-5 flex-shrink-0 flex items-center justify-center mr-2.5">
      ...
      <span className="flex-grow text-center tracking-wide font-medium">
        Pokračovat přes Google
      </span>
    </button>

    {/* SEZNAM TLAČÍTKO – Využívá SVG z public složky */}
    <button 
      type="button"
      className="w-full h-10 px-3 bg-white border border-gray-200 text-gray-800 text-sm font-medium rounded-2xl cursor-pointer flex items-center justify-between transition-all duration-200 hover:bg-gray-50 focus:outline-none"
    >
      <div className="w-5 h-5 flex-shrink-0 flex items-center justify-center mr-2.5">
        <Image 
